    ...
    <div class="row my-3">
        ...
        <form action="{{ route('project.store') }}" method="POST" >
         ...
         <div class="mb-3">
                ...
                <input type="text" class="form-control @error('prjleader') is-invalid @enderror" id="prjleader"  name="prjleader" required autofocus value="{{ old('prjleader') }}">
              @error('prjleader')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
         ...
         <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_klien') is-invalid @enderror" id="nama_klien"  name="nama_klien" required autofocus value="{{ old('nama_klien') }}">
              @error('nama_klien')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('progress') is-invalid @enderror" id="progress"  name="progress" required autofocus value="{{ old('progress') }}">
              @error('progress')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
